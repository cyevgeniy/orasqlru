...
".pks" для спецификации и ".pkb" для тела - это н. Когда нужно изменить пакет, код в этих файлах меняется,
...
датами и числами. Создадим свой пакет для вывода информации
